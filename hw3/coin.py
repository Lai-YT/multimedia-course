...
def get_coin() -> None:
    ...
    cv2.imwrite('coin_pic/coin_resize.jpg', coin)
    ...
    coin_value = 0
    result_target_coin = cv2.imread('coin_pic/coin_resize.jpg')
    ...
    cv2.imwrite('coin_pic/coin_get.jpg', result_target_coin)
...
def coin_background_and_inner_clean(coin_origin):
    ...
    cv2.imwrite('coin_pic/coin_adjust.jpg', coin_adjust)
